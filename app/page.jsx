		...
		<div className='relative mx-auto my-5 flex max-w-7xl flex-col items-center justify-center'>
			...
			<div className='px-4 py-10'>
				<h1 className='relative z-10 mx-auto max-w-4xl text-center text-3xl font-bold md:text-4xl lg:text-7xl dark:text-slate-300'>
					{'Instantly Understand Repositories With AI.'
						.split(' ')
						.map((word, index) => (
							<motion.span
								key={index}
				...
				>
					RepoAI automatically summarizes files and folders across GitHub repos,
					so you spend less time digging and more time building.
				</motion.p>
				<motion.div
					initial={{
						opacity: 0,
